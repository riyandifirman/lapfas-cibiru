...
<div class="panel panel-default">
    <div class="panel-heading">
        ...
        <div class="panel-options">
            <a href="<?php echo site_url('admin/jenis/manage'); ?>" class="btn btn-secondary btn-sm" style="color:#fff"> <i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Jenis Pengaduan</a>
        </div>
    </div>
...
<script type="text/javascript">
    $(".remove").click(function() {
        ...
        if (confirm('Yakin Menghapus jenis pengaduan Ini ??')) {
            $.ajax({
                ...
                success: function(data) {
                    $("#" + id).remove();
                    alert('Jenis Pengaduan berhasil dihapus');
                }
            });
        }
    });
