...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title">Jenis Pengaduan</h3>
    </div>
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">Nama Pengaduan<span class="required">*</span></label>

                <div class="col-sm-10">
                    <input type="text" class="form-control title" placeholder="Nama Pengaduan" name="title" value="<?php echo set_value('title', $item->title) ?>">
                </div>
            </div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">Icon Pengaduan <span class="required">*</span></label>
