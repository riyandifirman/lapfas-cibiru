...
<head>
    ...
    <style>
        ...
        <?php include 'styles/admin/default/assets/css/important.css'; ?>
    </style>
                    ...
                    <div class="user-info">
                        <div class="user-details">
                            ...
                            <div class="user-links">
                                <a href="<?php echo site_url('admin/users/manage/' . session('user_id')) ?>" class="btn btn-primary"> <i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Profil</a>
                                <a href="<?php echo site_url('admin/logout') ?>" class="btn btn-success"> <i class="fa fa-sign-out" aria-hidden="true"></i> Keluar</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <ul id="main-menu" class="main-menu">
                    ...
                    <li>
                        <a href="<?php echo site_url('admin/jenis') ?>">
                            ...
                            <span class="title">Jenis Pengaduan</span>
                        </a>
                    </li>
                    <li>
                    <li>
                        <a href="<?php echo site_url('admin/pengaduan') ?>">
                            ...
                            <span class="title">Daftar Pengaduan</span>
                        </a>
                        <ul>
                            <li>
            ...
            <footer class="main-footer sticky footer-type-1">
                ...
                <div class="footer-inner">
                    <div class="footer-text">
                        <strong><a href="">Powered By RANS Squad</a></strong>.
                    </div>
                    <div class="go-up">
                        <a href="#" rel="go-top">
