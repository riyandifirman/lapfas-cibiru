        ...
        <div class="col-md-12">
            <ul class="nav nav-tabs nav-tabs-justified">
                ...
                <li>
                    <a href="#tickets_pengaturans" data-toggle="tab">
                        ...
                        <span class="visible">Pengaturan Pengaduan</span>
                    </a>
                </li>
                <li>
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane" id="tickets_pengaturans">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Tampilkan pengaduan yang dikirim</label>
                        <div class="col-sm-10">
                    ...
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pesan Pengaduan tidak aktif</label>
                    ...
                    <div class="form-group-separator"></div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pesan balasan Pengaduan Tidak Aktif</label>
                        <div class="compose-message-editor col-sm-10">
