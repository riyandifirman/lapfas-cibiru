<div class="page-question">
    <div class="breadcrumb-env">
        ...
        <ol class="breadcrumb bc-1">
            ...
            <li class="active">
                <strong>Topik Pembahasan</strong>
            </li>
        </ol>
    </div>
</div>
...
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-question">Topik pembahasan</h3>
    </div>
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label">Jenis Pengaduan <span class="required">*</span></label>
                <div class="col-sm-10">
            ...
            <div class="form-group-separator"></div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1">Bahasan <span class="required">*</span> </label>

                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Pertanyaan" name="question" value="<?php echo set_value('question', $item->question) ?>">
                </div>
            </div>
            <div class="form-group-separator"></div>
            ...
            <div class="form-group">
                <label class="col-sm-2 control-label" for="field-1"> Status Bahasan<span class="required">*</span></label>
                <div class="col-sm-10">
                    <div class="row">
