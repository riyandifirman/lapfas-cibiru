<div style="direction: <?php echo lang('dir') ?>;color: #333; width: 60%; margin: auto; border: 1px solid #dedede; font-size: 16px;font-family: sans-serif;">
    ...
    <div style="padding-bottom: 15px; margin-bottom: 15px; padding: 20px;text-align: center;">
        ...
        <p style="line-height: 28px;">
            Ada balasan baru di pengaduan  <a href="<?= site_url('dashboard/ticket/' . $kkk->pengaduan_id) ?>">#<?php echo $kkk->pengaduan_id ?>: <?php echo $kkk->subject ?></a><br>
            Lihat pengaduan anda dengan klik link berikut
            <br><br>
            <b>Terimakasih!</b>
            <br>
        </p>
        <a href="<?= site_url('dashboard/ticket/' . $kkk->pengaduan_id) ?>" style="text-decoration: none; background-color: #f2435a;padding: 10px;margin: 10px;display: inline-block;color: #fff; border-radius: 2px;">Periks pengaduan anda</a>
    </div>
