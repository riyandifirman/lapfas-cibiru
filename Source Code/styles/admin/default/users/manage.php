    ...
    <div class="panel-body">
        ...
        <form role="form" class="form-horizontal" role="form" method="post" enctype="multipart/form-data">
            <div class="form-group">
                <label class="col-sm-2 control-label">Grup Pengguna <span class="required">*</span></label>
                <div class="col-sm-10">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Username" name="username" value="<?php echo set_value('username', $item->username) ?>">
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Nama Depan" name="firstname" value="<?php echo set_value('firstname', $item->firstname) ?>">
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Nama Belakang" name="lastname" value="<?php echo set_value('lastname', $item->lastname) ?>">
                </div>
            </div>
            <div class="form-group-separator"></div>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" class="form-control" placeholder="Email" name="email" value="<?php echo set_value('email', $item->email) ?>">
                </div>
            </div>
            <div class="form-group-separator"></div>
            ...
            <div class="form-group">
                ...
                <div class="compose-message-editor col-sm-10">
                    <input type="radio" value="pria" name="gender" <?php if (set_value('gender', $item->gender) == 'pria') : ?>checked="checked" <?php endif; ?>>
                    Pria<br />
                    <input type="radio" value="wanita" name="gender" <?php if (set_value('gender', $item->gender) == 'wanita') : ?>checked="checked" <?php endif; ?>> Wanita
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
                ...
                <div class="compose-message-editor col-sm-10">
                    <input type="radio" value="aktif" name="status" <?php if (set_value('status', $item->status) == 'aktif') : ?>checked="checked" <?php endif; ?>>
                    Aktif<br />
                    <input type="radio" value="nonaktif" name="status" <?php if (set_value('status', $item->status) == 'nonaktif') : ?>checked="checked" <?php endif; ?>> Nonaktif
                </div>
            </div>
            <div class="form-group-separator"></div>
            <div class="form-group">
