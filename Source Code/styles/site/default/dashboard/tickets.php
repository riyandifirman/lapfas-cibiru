                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-danger btn-filter" data-filter="important">Penting</button>
                                <button type="button" class="btn btn-warning btn-filter" data-filter="buka">Berjalan</button>
                                <button type="button" class="btn btn-success btn-filter" data-filter="selesai">Selesai</button>
                            </div>
                        </div>
                        <div class="col-md-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table table-filter">
                                        <tbody>
                                                    ...
                                                    <td>
                                                        <div class="media">
                                                            <a href="<?php echo site_url('dashboard/ticket/' . $item->pengaduan_id) ?>" class="media-body">
                                                                <h4 class="title">
                                                                    <span class="dep-title"><b>Jenis Pengaduan :</b> <?php echo $item->category ?></span> <?php echo $item->subject ?>
                                                                </h4>
                                            ...
                                            <?php if (!$items) : ?>
                                                <tr>
                                                    <td colspan="6" class="textcenter">Belum ada Pengaduan</td>
                                                </tr>
                                            <?php endif ?>
                                        </tbody>
                                    </table>
